...
#include "../resource/breakpoint.xpm"
...
wxSTC_WRAP_WORD: wxSTC_WRAP_NONE);
              ...
              SetMarginType(m_FoldingID, wxSTC_MARGIN_SYMBOL);
               ...
               //SetMarginMask(m_LineNrID, ~(256 | 512 | 128 | wxSTC_MASK_FOLDERS));
              ...
              SetMarginMask(m_FoldingID, ~(wxSTC_MASK_FOLDERS));
               ...
               //SetMarginSensitive(m_LineNrID, true);
              ...
              MarkerDefine (wxSTC_MARKNUM_FOLDERSUB,     wxSTC_MARK_VLINE,     wxT("BLACK"), wxT("BLACK" ));
              ...
              MarkerDefine (wxSTC_MARKNUM_FOLDERMIDTAIL, wxSTC_MARK_TCORNER,     wxT("BLACK"), wxT("BLACK" ));
              MarkerDefine (wxSTC_MARKNUM_FOLDERTAIL,    wxSTC_MARK_LCORNER,     wxT("BLACK"), wxT("BLACK" ));
...
void Edit::OnMarginClick (wxStyledTextEvent &event) {
        ...
        switch (event .GetMargin())
       {
        ...
        case 1: // bookmarks and breakpoints margin
              {
                     wxString sourceFullPath = wxGetCwd().c_str();
                     wxString sourceRelativePath = wxGetCwd().c_str();
                      ...
                      if ( true )
                     {
                            ...
                            if (mask)
                           {
								  ...
								  breakpoint_flag = false;
								  deleteline=line;
								  //auto it = std::find(breakpointsvec.begin(), breakpointsvec.end(), deleteline);
								  breakpointsvec.erase(std::remove(breakpointsvec.begin(), breakpointsvec.end(), line),breakpointsvec.end());
								  //if(it != breakpointsvec.end()){
									 // breakpointsvec.erase(it);}
                           }
                            else
                           {
...
void Edit::AddBreakpoint(wxString path, int addLine)
{
        if ( true )
       {
               //m_console->Puts(wxT("\n"));
